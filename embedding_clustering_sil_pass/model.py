...
def expand_as_pair(input_feats):
    """
...
class GATConv(nn.Module):
    def __init__(
        ...
        attn_drop=0.0,
        negative_slope=0.2,
        residual=True,  # Set default to True
        activation=None,
        ...
        # Define linear transformations for source and destination nodes
...
class GATConv_from_dgl(nn.Module):
...
class GATConv_no_residual(nn.Module):
    def __init__(
        self,
        in_feats,
        out_feats,
